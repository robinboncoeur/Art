...
I so wish that there was a place for Works In Progress. I'll be polishing this over the next weeks. Don't even know if that's cool.
...
By the way, I can't seem to get MS to include the full score in Landscape mode into a PDF. That's a fail. Maybe I need to select a larger paper format, perhaps? Tried ledger-sized paper: seems to work.
...
Practising my violin: this is definitely uphill work. The bow wants to chatter and involve more than on string at a time: typical rookie stuff. Good job I got the mute for it!
...
[Old VST](https://shopvst.com/1552)
...
From your arrangements I think you'll know how. After all, there are many composer styles to look into - as long as you match it with your material. For example, (assuming you still want this type of input) in this style there is straight-forward doubling. You have ended up with several simultaneous bass lines (between Contrabass, violoncello, trombone, bassoon) in several places. The uniformity of bass line at m 26 sounds more solid, though you do not need the viola on that line.

The stylistic solution would be divide into 4 parts:

- Fl,Ob, Cl, Bassoon 	
- double 	
- Vln1, Vln2, Clarinet and CB/VC. 
