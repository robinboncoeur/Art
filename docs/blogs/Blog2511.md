...
**04.Nov.2025**  
I do depend a lot on "blogs" *(ChatGPT)*. Just read a bit more on FluxGym (for creating Flux LoRAs) and the article claim I should be able to *easily* throw a 60-image dataset at it. Well, my install kept pooing itself with as few as 12 images. Thought I'd try a different model. My [discussion with blogs](../work/FluxGym.md) have resolved that issue, thankfully. I was able to create a LoRA *(moimeme4)* with 16 images. Yes, it takes a long time, but I'm pretty happy with the results.
